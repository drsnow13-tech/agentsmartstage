    ...
    <div className="flex flex-col">
      ...
      <section className="bg-gradient-to-br from-[#1E3A8A] to-[#1e2d6b] text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-blue-300 text-sm mt-4">First photo free · No login required · Photos not stored after 24 hours · MLS-ready results</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: '🌅', title: 'Virtual Twilight', desc: 'Golden hour sky and warm glowing windows — agents report more saves and faster offers' },
              { icon: '🌿', title: 'Green the Grass', desc: 'Lush vibrant lawn year-round. No more dead or patchy grass killing your curb appeal' },
              { icon: '🛋', title: 'Virtual Staging', desc: 'Fill empty rooms with warm, inviting furniture — living room, bedroom, game room, office and more' },

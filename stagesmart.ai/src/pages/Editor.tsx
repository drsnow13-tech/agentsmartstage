...
const ROOM_OPTIONS: Record<string, EditOption[]> = {
  ...
  'Living Room': [
    { id: 'stage-warm', label: 'Warm & Inviting', description: 'Cozy, styled, ready to sell', emoji: '🛋️', prompt: 'Photoreal warm and inviting living room virtual staging. Add: a large plush sofa and accent chair in warm cream, camel, or sage tones, a wood coffee table with a styled tray, candles, and a coffee table book, a large soft area rug centered under the furniture, two table lamps with warm amber light, a tall potted fiddle leaf fig or olive tree in one corner, a medium potted plant on a side table, three pieces of tasteful framed art on the walls — one large statement piece above the sofa and two smaller ones arranged on an adjacent wall, cozy throw blanket draped over the sofa arm. Keep ALL walls, floors, windows, baseboards, and architectural details exactly identical. Warm glowing light, MLS-ready real estate photography.' },
    { id: 'stage-traditional', label: 'Traditional Staging', description: 'Classic, warm, polished', emoji: '🏡', prompt: 'Photoreal traditional living room virtual staging. Add: a classic sofa and loveseat in warm cream or soft blue, wood coffee table with floral centerpiece and candles, a large patterned area rug centered under seating, two table lamps on end tables with warm light, a tall potted plant in corner, framed botanical or landscape art above sofa plus two smaller framed pieces on side walls, decorative throw pillows in coordinating warm tones. Keep ALL walls, floors, windows, and architecture exactly identical. Warm inviting lighting, MLS-ready real estate photography.' },
    { id: 'stage-modern', label: 'Modern Staging', description: 'Clean lines, still warm', emoji: '✨', prompt: 'Photoreal modern yet warm living room virtual staging. Add: a low-profile sectional in light grey or ivory, sleek wood coffee table with a small succulent and stack of books, a large solid-color area rug, a floor lamp with warm light, one large abstract canvas art piece above sofa, a medium potted snake plant or monstera in corner. Keep ALL walls, floors, windows, and architecture exactly identical. Bright warm lighting, MLS-ready real estate photography.' },
    { id: 'declutter', label: 'Declutter & Clean', description: 'Remove furniture, personal items', emoji: '🧹', prompt: 'Remove ALL existing furniture, personal items, decor, and clutter from this room. Keep walls, floors, baseboards, windows, doors, ceiling, and all architectural features exactly identical. Result: a bright, clean, empty room. Professional real estate photography.' },
    { id: 'brighten', label: 'Brighten & Enhance', description: 'More light, better colors', emoji: '💫', prompt: 'Brighten this room significantly. Enhance natural light coming through windows, improve white balance, boost warmth and vibrancy, reduce shadows. Keep all furniture, decor, and architectural elements exactly identical — only improve lighting and color. Professional real estate photography.' },
  ],
  'Dining Room': [
    { id: 'stage-warm', label: 'Warm & Inviting', description: 'Styled dining, ready to entertain', emoji: '🍽️', prompt: 'Photoreal warm and inviting dining room virtual staging. Add: a rectangular wood dining table in warm walnut or oak, 6 upholstered chairs in cream or warm taupe, a LARGE area rug with subtle warm-toned pattern centered UNDER the table extending at least 24 inches beyond all sides of the table, a statement chandelier or pendant above the table with warm light, a centerpiece of fresh flowers in a vase plus candles, a tall potted plant or fig tree in one corner, two pieces of framed art on the dining room walls — one large landscape or abstract, one smaller accent piece. Keep ALL walls, floors, windows, and architecture exactly identical. Warm inviting lighting, MLS-ready real estate photography.' },
    { id: 'stage-traditional', label: 'Traditional Staging', description: 'Classic dining room', emoji: '🏡', prompt: 'Photoreal traditional dining room virtual staging. Add: a dark wood rectangular dining table, 6 classic upholstered dining chairs in cream or sage, a large area rug with classic pattern centered UNDER table extending 24 inches beyond all sides, chandelier above table, elegant floral centerpiece with candelabra, a buffet or sideboard against one wall with a mirror above it, framed art on walls, small potted plant on sideboard. Keep ALL walls, floors, windows, architecture exactly identical. Warm elegant lighting, MLS-ready real estate photography.' },
    { id: 'stage-modern', label: 'Modern Staging', description: 'Clean, minimal dining', emoji: '✨', prompt: 'Photoreal modern dining room virtual staging. Add: a light wood or white rectangular table, 6 minimalist upholstered chairs in light grey, a large solid-color area rug centered UNDER the table extending 24 inches beyond all sides, a sculptural pendant light above, simple greenery centerpiece, one large abstract art piece on main wall. Keep ALL walls, floors, windows, architecture exactly identical. Bright clean lighting, MLS-ready real estate photography.' },
  ...
  'Kitchen': [
    { id: 'brighten', label: 'Brighten & Enhance', description: 'More light, better colors', emoji: '💫', prompt: 'Brighten this kitchen significantly. Enhance natural light, improve white balance, make countertops and cabinets look cleaner and more vibrant, boost warmth. Keep all cabinets, appliances, countertops, and architectural elements exactly identical. Professional real estate photography.' },
    { id: 'declutter', label: 'Declutter Countertops', description: 'Clean minimal counters', emoji: '🧹', prompt: 'Remove ALL clutter from countertops — small appliances, dishes, papers, personal items. Keep all built-in appliances (fridge, stove, dishwasher), cabinets, countertops, backsplash exactly identical. Add only: a small potted herb plant, a clean dish towel, a simple fruit bowl with fresh fruit. Professional real estate photography.' },
    { id: 'stage-warm', label: 'Warm & Styled', description: 'Cozy kitchen styling', emoji: '🛋️', prompt: 'Photoreal warm kitchen staging. Clear all clutter from countertops. Add tasteful warm styling: a small potted herb garden near window, a wooden cutting board leaned against backsplash, a bowl of fresh lemons or fruit, a folded linen dish towel, a small vase with fresh flowers. Keep all cabinets, appliances, countertops, backsplash exactly identical. Warm bright professional real estate photography.' },
  ],
  'Bedroom': [
    { id: 'stage-warm', label: 'Warm & Inviting', description: 'Cozy bedroom, beautifully styled', emoji: '🛋️', prompt: 'Photoreal warm and inviting bedroom virtual staging. Add: an upholstered or wood headboard bed with layered white and warm-toned bedding, Euro pillows plus decorative throw pillows, a cozy folded blanket at foot of bed, two nightstands with warm-glowing table lamps, a large soft area rug extending at least 18 inches beyond the sides and foot of the bed, a potted plant on one nightstand or dresser, a tall plant in one corner of the room, one large framed art piece above the headboard, one or two smaller framed pieces on adjacent walls. Keep ALL walls, floors, windows, and architecture exactly identical. Warm inviting lighting, MLS-ready real estate photography.' },
    { id: 'stage-traditional', label: 'Traditional Staging', description: 'Classic, polished bedroom', emoji: '🏡', prompt: 'Photoreal traditional bedroom virtual staging. Add: a classic upholstered headboard bed with crisp white and cream layered bedding, decorative pillows, two matching wood nightstands with table lamps, a soft patterned area rug extending beyond the bed on both sides, a small potted plant or fresh flowers on one nightstand, framed landscape or botanical art above headboard and on side walls. Keep ALL walls, floors, windows, architecture exactly identical. Warm elegant lighting, MLS-ready real estate photography.' },
    { id: 'brighten', label: 'Brighten & Enhance', description: 'More light, better colors', emoji: '💫', prompt: 'Brighten this bedroom. Enhance natural light, improve color balance and warmth, reduce shadows. Keep all furniture, decor, and architectural elements exactly identical. Professional real estate photography.' },
    { id: 'declutter', label: 'Declutter & Clean', description: 'Remove clutter, personal items', emoji: '🧹', prompt: 'Remove ALL personal items, clutter, clothes, and loose items from this bedroom. Keep all furniture, beds, dressers, and built-in features exactly identical. Clean, tidy, depersonalized. Professional real estate photography.' },
  ],
  default: [
    { id: 'stage-warm', label: 'Warm & Inviting', description: 'Cozy, styled, ready to sell', emoji: '🛋️', prompt: 'Photoreal warm and inviting virtual staging. Add appropriate furniture for this room type in warm cream, camel, and wood tones. Include: a large area rug under any seating or dining furniture, tasteful plants including one tall corner plant and one on a surface, framed art on the walls including one large statement piece and smaller accent pieces, warm ambient lighting from table lamps or pendants. Keep ALL walls, floors, windows, and architecture exactly identical. Warm inviting lighting, MLS-ready real estate photography.' },
    { id: 'stage-traditional', label: 'Traditional Staging', description: 'Classic, warm, polished', emoji: '🏡', prompt: 'Photoreal traditional virtual staging. Add classic furniture in warm cream and wood tones with an area rug under seating, table lamps with warm light, potted plants, and framed art on walls. Keep ALL walls, floors, windows, and architecture exactly identical. Warm elegant lighting, MLS-ready real estate photography.' },
    { id: 'stage-modern', label: 'Modern Staging', description: 'Clean lines, still warm', emoji: '✨', prompt: 'Photoreal modern virtual staging. Add contemporary furniture in light grey and ivory with clean lines, a large area rug, one large abstract art piece, and a potted plant. Keep ALL walls, floors, windows, and architecture exactly identical. Bright warm lighting, MLS-ready real estate photography.' },
    { id: 'declutter', label: 'Declutter & Clean', description: 'Remove furniture, personal items', emoji: '🧹', prompt: 'Remove ALL existing furniture, personal items, decor, and clutter. Keep walls, floors, windows, doors, ceiling, and all architectural features exactly identical. Bright clean empty room. Professional real estate photography.' },
    { id: 'brighten', label: 'Brighten & Enhance', description: 'More light, better colors', emoji: '💫', prompt: 'Brighten the room, enhance natural light, improve color balance and warmth. Keep all furniture, decor, and architectural elements exactly identical. Professional real estate photography.' },
  ]
};
